        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
            ...
            <div className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
              ...
              <button
                onClick={placeOrder}
                disabled={orderLoading || (deliveryOption === 'delivery' && (!!addressError || !deliveryAddress))}
                className={`w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md font-medium text-sm sm:text-base flex items-center justify-center ${
                  orderLoading || (deliveryOption === 'delivery' && (!!addressError || !deliveryAddress)) ? 'opacity-70 cursor-not-allowed' : ''
                }`}
              >
                {orderLoading ? (
                  <>
